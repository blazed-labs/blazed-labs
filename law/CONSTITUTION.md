...
The agent id portion shall be a UUID which is not being used under the selected agent type namespace.
...
1. [The Greater City of Blazed (GCOB)](https://github.com/blazed-labs/blazed-labs/wiki/Blazed-Districts)
2. [Swell City](https://github.com/blazed-labs/blazed-labs/wiki/Swell-Districts)
3. [Mosno City](https://github.com/blazed-labs/blazed-labs/wiki/Mosno-Districts)
4. [Magnolia City](https://github.com/blazed-labs/blazed-labs/wiki/Magnolia-Districts)
5. [Ferringwood Village](https://github.com/blazed-labs/blazed-labs/wiki/Ferringwood-Districts)
6. [Hermopolis Town](https://github.com/blazed-labs/blazed-labs/wiki/Hermopolis-Districts)
7. [Memphis City](https://github.com/blazed-labs/blazed-labs/wiki/Memphis-Districts)
8. [Chelsea Seaport](https://github.com/blazed-labs/blazed-labs/wiki/Chelsea-Districts)
...
# 4. Assets
## 4.A Definition
An asset is simply a virtual item. This item may have a variety of metadata, stored as JSON.
